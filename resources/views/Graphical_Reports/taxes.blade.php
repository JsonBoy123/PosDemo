		...
		<form action="{{route('taxGraphReportShow')}}"  enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			...
			<div class="form-group form-group-sm">
				...
				<div id="report_sale_type" class="col-xs-3">
					...
					<option value="0" selected="selected">Completed Sales and Returns</option>
					<option value="3">Completed Sales</option>
			...
			<button type="submit" class="btn btn-primary btn-sm" style="margin-left:80px;">Submit</button>
		</form>
