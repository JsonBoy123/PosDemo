...
<div class="container">
	<div id="page_title">Discount Detail Report</div><br>

	<a href="{{route('detailed-discounts-index')}}" class="btn btn-primary btn-sm pull-right">Back</a>
				...
				<div class="card-body table-responsive">
					<table class="table table-striped table-hover" id="CategoryTable">
						...
						<tbody>
							...
							{{-- @foreach($sales as $val)
							<tr>
								<td>{{$val['sale_items']->item_unit_price}}</td>
							</tr>
							@endforeach --}}
						</tbody>
					</table>
